...
map.getView().fit([-128028.327301, 1464367.140524, -112269.510029, 1472969.408641], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">REPERES DE NIVELLEMENT DE LA VILLE DE KAYA</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_Represdenivellement_2,
    colName: 'Nom',
    zoom: 10,
    collapsed: true,
    map: map
